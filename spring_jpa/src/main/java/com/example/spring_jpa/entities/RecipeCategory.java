...
public class RecipeCategory {
    ...
    @OneToMany(fetch = FetchType.EAGER, mappedBy = "recipe_category", cascade = {CascadeType.DETACH, CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REFRESH}, orphanRemoval = true)
